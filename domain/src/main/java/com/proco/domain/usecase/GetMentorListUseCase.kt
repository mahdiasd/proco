...
class GetMentorListUseCase @Inject constructor(
...
) : ResultUseCase<GetMentorListUseCase.GetMentorListParam, Flow<DataResult<List<UserSummary>>>>(dispatcher) {
    ...
    override suspend fun doWork(params: GetMentorListParam): Flow<DataResult<List<UserSummary>>> {
